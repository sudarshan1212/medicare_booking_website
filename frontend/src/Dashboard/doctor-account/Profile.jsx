...
const Profile = ({ doctorData }) => {
  ...
  return (
    <div>
      <h2 className=" text-headingColor font-bold text-2xl leading-9 mb-10 ">
        Profile Information
      </h2>
      <form action="">
        <div className="mb-5">
          <p className="form_-label">Name*</p>
          <input
            type="text"
            name="name"
            value={formData.name}
        ...
        <div className="mb-5">
          <p className="form_-label">Email*</p>
          <input
            type="text"
            name="email"
        ...
        <div className="mb-5">
          <p className="form_-label">Phone*</p>
          <input
            type="number"
            name="phone"
          ...
          <div className="grid grid-cols-3 gap-5 mb-[30px]">
            ...
            <div>
              ...
              >
                ...
                <option value="dermatiologist">dermatiologist</option>
              </select>
            </div>
            <div>
        ...
        <div className="mb-5">
            ...
            <div key={index}>
              <div>
                ...
                <button
                  ...
                  className=" bg-red-600 p-2 rounded-full text-white text-base mt-2 mb-[30px] cursor-pointer"
                >
                  <AiOutlineDelete />
                </button>
              </div>
          ...
          <button
            onClick={addQaualification}
            className=" bg-black py-2 p-2  text-white h-fit cursor-pointer"
          >
            Add Qualification
          </button>
        </div>
          ...
          {formData.experiences?.map((item, index) => (
            <div key={index}>
              <div>
                ...
                <div className="grid grid-cols-2 gap-5">
                  <div>
                    <p className="form__label">Postions*</p>
                    <input
                      type="text"
                      name="position"
                      value={item.position}
        ...
        <div className="mb-5">
          ...
          {formData.timeSlots?.map((item, index) => (
            <div key={index}>
              <div>
                <div className="grid grid-cols-2 md:grid-cols-4 mb-7 gap-5 ">
                  <div>
                  ...
                  >
                    <button className=" bg-red-600 p-2 rounded-full text-white text-base text-center cursor-pointer">
                      <AiOutlineDelete />
                    </button>
                  </div>
                </div>
        ...
        <div className="mt-7">
          <button
            ...
            className=" bg-primaryColor text-white text-base leading-7 w-full py-3 px-4 rounded-lg "
          >
            Update Profile
          </button>
        </div>
